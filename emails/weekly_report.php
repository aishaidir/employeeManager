				...
				<div style="background: #f9f9f9;font-family:"Karla", sans-serif;font-size:15px;padding: 1em;">
					...
					<div style="width: 100%;max-width:650px;margin: 0 auto;background: #fff;border-top: 3px solid #03a9f4;border-radius: 4px;">
						...
						<table border="0" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:4px;width: 100%;">
							...
							<p style="font-size:18px;padding-bottom: 20px;">Hi '. $supervisorFirstName .',</p>
							<p style="padding-bottom: 20px;"><strong>'. $name .'</strong> has submitted their report for '. $month .'/'. $year .', week '. $week .'. </p>
							<a href="http://69.64.87.150:9090/stm_v1.0/report/'. strtolower($month) .'/'. $year .'/'. $week .'/'. $weeklyId .'/'. $report->uid .'/#'. $username .'" style="color: #03a9f4;font-size: 15px;padding-bottom: 40px;display: block;">Click here to review</a>
